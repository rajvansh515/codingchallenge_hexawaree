    ...
    public class CareerHubService
    {
        ...
        public void InsertJobApplication()
        {
            try
            {
                ...
                // Check if application is submitted before the deadline (mock deadline logic)
                DateTime applicationDeadline = DateTime.Now.AddDays(7); // Example: 7 days from now
        ...
        public void UploadResume()
        {
            try
            {
                ...
                // Check file existence and size (mock check)
